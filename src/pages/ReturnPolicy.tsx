        ...
        <div className="space-y-8">
              ...
              <div>
                ...
                <div className="rounded-lg bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800 px-3.5 py-2.5">
                  <p className="text-xs text-amber-800 dark:text-amber-300 leading-relaxed">
                    ...
                    <a href="https://www.tiktok.com/@professor_pfm" target="_blank" rel="noopener noreferrer" className="underline hover:no-underline">TikTok @professor_pfm</a>{' '}
          ...
          <div className="text-center pt-4">
            <p className="text-sm text-muted-foreground">
              ...
              <a href="https://www.tiktok.com/@professor_pfm" target="_blank" rel="noopener noreferrer" className="text-accent font-medium hover:underline">
