              ...
              <AccordionItem key={index} value={`faq-${index}`} className="border-border">
                ...
                <AccordionContent className="text-sm text-muted-foreground whitespace-pre-line leading-relaxed">
                  {faq.answer === "why-cheap" ? (
                    ...
                    <span>
                      Message us on our{' '}
                      <a href="https://www.tiktok.com/@professor_pfm" target="_blank" rel="noopener noreferrer" className="text-accent font-medium hover:underline">tik tok</a>
                    ...
                    <span>
                      ...
                      <a href="https://www.tiktok.com/@professor_pfm" target="_blank" rel="noopener noreferrer" className="text-accent font-medium hover:underline">message us on TikTok</a>
                    ...
                    <span>
                      ...
                      <a href="https://www.tiktok.com/@professor_pfm" target="_blank" rel="noopener noreferrer" className="text-accent font-medium hover:underline">TikTok</a>{' '}
                      if you're confused!{'\n\n'}
